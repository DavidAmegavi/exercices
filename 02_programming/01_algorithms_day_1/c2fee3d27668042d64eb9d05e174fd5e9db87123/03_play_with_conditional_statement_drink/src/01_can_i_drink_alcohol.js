...
let frieda = {age: 22,name: "Frieda"}; 
let francis = {age: 17,name: "Francis"}; 
...
if(frieda.age > 18){canFriedaDrinkAlcohol = true;} else{canFriedaDrinkAlcohol= false;}

if (francis.age < 18){ canFrancisDrinkAlcohol = false;}else{canFrancisDrinkAlcohol = true;}
